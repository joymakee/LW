...
@property (nonatomic, strong) UIView *bottomBackView;//底部黑色view
...
- (void)showWithImageViews:(NSArray*)views selectedView:(UIImageView*)selectedView  andTag:(NSInteger)tag{
